...
for(n in number_of_examples){
  samples <- rnorm(n, mean=0, sd=1)     # Generate a random normal value with mean = 0 and standard deviation = 1
  within_range <- sample>-1 & sample<1  # Logical vector: True if between -1 and +1
